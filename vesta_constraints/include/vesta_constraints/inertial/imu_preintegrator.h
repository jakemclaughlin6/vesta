...
{
  ImuData() = default;
  ImuData(const vesta_core::Timestamp& stamp, const Eigen::Vector3d& angular_velocity,
...
public:
  ...
  void increment(double dt, const ImuData& data, const Eigen::Vector3d& bg, const Eigen::Vector3d& ba,
                 bool compute_jacobian, bool compute_covariance);

  bool integrate(const vesta_core::Timestamp& t, const Eigen::Vector3d& bg, const Eigen::Vector3d& ba,
