^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
Changelog for package vesta_variables
^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
...
* Removed vesta_variables default constructors (`#5 <https://github.com/locusrobotics/fuse/issues/5>`_)
* Move the vesta_variables package into the public repo (`#4 <https://github.com/locusrobotics/fuse/issues/4>`_)
* Contributors: Stephen Williams, Tom Moore
